...
const register = async (req, res) => {
  ...
  try {
    ...
    // Restricción de Roles: Solo un Administrador autenticado puede crear otros Administradores o Docentes.
    // Si no está autenticado o no es rol 1, forzar rol a 3 (Alumno)
    let final_rol = 3; // Por defecto Alumno
